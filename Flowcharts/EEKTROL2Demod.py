...
class EEKTROL2Demod(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "EEKTRO-L Demodulator")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("EEKTRO-L Demodulator")
        ...
        self.settings = Qt.QSettings("GNU Radio", "EEKTROL2Demod")
        ...
        # Variables
        ##################################################
        self.symbol_rate = symbol_rate = 30.72e6
        self.samp_rate = samp_rate = 163.84e6
        ...
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(0.030, 2, False)
        self.digital_clock_recovery_mm_xx_0 = digital.clock_recovery_mm_cc(sps/2, 8.7e-3**2/4.0, 0.5, 8.7e-3, 0.05)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, '', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.analog_agc_xx_0 = analog.agc_cc(1e-7, 1.0, 1.0)
        ...
        self.connect((self.blocks_repack_bits_bb_0_0, 0), (self.digital_diff_decoder_bb_0, 0))
    ...
    def set_symbol_rate(self, symbol_rate):
        ...
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, self.symbol_rate*2, 0.5, 361))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.digital_clock_recovery_mm_xx_0.set_omega(self.sps/2)





def main(top_block_cls=EEKTROL2Demod, options=None):
